...
let rec addCST i C =
    ...
    | (1, DIV        :: C1) -> C1
    | (0, EQ         :: C1) -> addNOT C1
    | (i1, CSTI i2 :: EQ :: C1) -> if i1 = i2 then addCST 1 C1 else addCST 0 C1
    | (i1, CSTI i2 :: LT :: C1) -> if i1 < i2 then addCST 1 C1 else addCST 0 C1
    | (i1, CSTI i2 :: SWAP :: LT :: C1) -> if i2 < i1 then addCST 1 C1 else addCST 0 C1
    ...
    | Switch(e,sList) ->
        ...
        let rec switch stmts C = 
                ...
                | (i,stmt)::xs -> 
                        ...
                        DUP :: addCST i (EQ :: addIFNZRO labelse (switch xs C1))
