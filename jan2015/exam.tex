...
\section*{Makefile}
\lstinputlisting[language=make]{Fun/Makefile}
\section*{ex23}
...
\section*{ex33.c}
\lstinputlisting[language=C]{MicroC/ex33.c}
\section*{ex34.c}
\lstinputlisting[language=C]{MicroC/ex34.c}
\section*{exarrlen.c}
\lstinputlisting[language=C]{MicroC/exarrlen.c}
\section*{exrange.c}
\lstinputlisting[language=C]{MicroC/exrange.c}
...
\section*{FunLex.fsl}
\lstinputlisting[language=ML]{Fun/FunLex.fsl}
\section*{FunPar.fsy}
\lstinputlisting[language=ML]{Fun/FunPar.fsy}
\section*{Absyn.fs}
\lstinputlisting[language=ML]{Fun/Absyn.fs}
\section*{HigherFun.fs}
\lstinputlisting[language=ML]{Fun/HigherFun.fs}
\chapter{MicroC kode}

I dette appendiks ses alle de opgivede Micro filer jeg har ændret i

\section*{CLex.fsl}
\lstinputlisting[language=ML]{MicroC/CLex.fsl}
\section*{CPar.fsy}
\lstinputlisting[language=ML]{MicroC/CPar.fsy}
\section*{Absyn.fs}
\lstinputlisting[language=ML]{MicroC/Absyn.fs}
\section*{Comp.fs}
\lstinputlisting[language=ML]{MicroC/Comp.fs}
\section*{Machine.fs}
\lstinputlisting[language=ML]{MicroC/Machine.fs}
\section*{Machine.java}
\lstinputlisting[language=Java]{MicroC/Machine.java}
